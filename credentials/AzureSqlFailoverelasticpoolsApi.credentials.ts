...
export class AzureSqlFailoverelasticpoolsApi implements ICredentialType {
	name = 'N8nDevAzureSqlFailoverelasticpoolsApi';

	displayName = 'Azure SQL Failoverelasticpools API';

	icon: Icon = { light: 'file:../nodes/AzureSqlFailoverelasticpools/azure-sql-failoverelasticpools.png', dark: 'file:../nodes/AzureSqlFailoverelasticpools/azure-sql-failoverelasticpools.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your Azure SQL Failoverelasticpools API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
